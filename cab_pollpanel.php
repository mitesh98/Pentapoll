...
<form action="cab_pollpreview.php?cab_id=<?=$_GET['cab_id'] ?>" method="post" enctype="multipart/form-data" id="poll_form">
<input type='file' id="poll_image" accept="images" name="poll_pic" style="display:none">
  ...
  <!-- <div class="custom-button-4 text-center" style="border:none;"><button class="custom-button-1">choose file</button></div>-->
	...
	<input type="submit" name="cab_poll_create_btn"  class="custom-button-1" value="create poll">
	</div>
