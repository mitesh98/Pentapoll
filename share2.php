 ...
 <div class="panel-body">
   <p class="question"><?=$row['question'] ?></p>
    ...
    <input type="radio" id="q1op1" name="option" onclick=" opt=<?=$poll_id?>;opt=(opt*10)+1;"><label for="q1op1">&nbsp;<?=$row['option1']?></label>
            ...
            <div class="panel-footer text-center" style="border:none;"><button class="custom-button-1" id="poll_button<?=$poll_id?>">Poll it</button></div>
			 </div>
	</div>
<div id="write"></div>
</html>
...
var login='<?=$login?>';
	...
	{
		//alert(opt);	
		$.post("share_signup_login.php",function(data){
		 $("#write").html(data);
		 });
	}
	else if(login)
