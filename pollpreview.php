...
$("#post_button").hide();
	...
	//if(check==0)
		//{
			...
			$.post("poll_post.php",{poll_id:poll_id,tag:tag,question:question,option1:option1,option2:option2,option3:option3,option4:option4,option5:option5,file_to_saved:file_to_saved},function(data){
